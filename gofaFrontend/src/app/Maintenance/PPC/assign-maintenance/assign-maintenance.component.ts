...
export class AssignMaintenanceComponent implements OnInit {
  ...
  updateRequestedTo(): void {
    switch (this.maintenanceType) {
      case 'Office_machine':
        this.requestedTo = 'Office_machinne MaintenanceM';
        break;
      case 'POWER':
        this.requestedTo = 'POWWER MaintenanceM';
        break;
      case 'RADIO_MAINTENANCE':
        this.requestedTo = 'RADIO_MAINTENANCE MaintenanceM';
        break;
        case 'HF_RADIO':
        this.requestedTo = 'HF_RADDIO MaintenanceM';
        break;
      default:
        this.requestedTo = '';
    }
